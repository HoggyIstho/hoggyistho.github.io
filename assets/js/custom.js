			...
			$(".contact-form").validate({
				...
				messages: {
					...
					ContactEmail: {
						...
						customemail: "El correo electrónico no es válido."
					},
				},
			...
			$(".footer-subscribe").validate({
				...
				messages: {
					ContactEmail: {
						required: "El campo de correo electrónico es obligatorio.",
						email: "El campo de correo electrónico es obligatorio.",
						customemail: "El campo de correo electrónico es obligatorio."
					},
				},
				submitHandler: function(form) {
		...
		detectIE: function() {
			...
			if(this.detectIECheck()) {
				var body = document.querySelector("body"),
					msg = 'Desafortunadamente, el navegador Internet Explorer que usa está desactualizado y no puede mostrar el sitio normalmente. <br> Abra el sitio en otro navegador.';
